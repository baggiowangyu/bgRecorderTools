#ifndef _bgSmtpProtocol_H_
#define _bgSmtpProtocol_H_
...
class bgSmtpProtocol
{
public:
	bgSmtpProtocol(const std::string & charset = "gb2312");
	~bgSmtpProtocol();
...
public:
	 ...
	 *	@password		密码
	 *	@servername		服务器名
	 *	@port			端口（端口其实不用指定，libcurl默认25，但如果是smtps则默认是465）
	 * 返回值：
	 *	@
	 */
